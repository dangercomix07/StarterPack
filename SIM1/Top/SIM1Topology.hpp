// ======================================================================
// \title  SIM1Topology.hpp
// \brief header file containing the topology instantiation definitions
//
// ======================================================================
#ifndef SIM1_SIM1TOPOLOGY_HPP
#define SIM1_SIM1TOPOLOGY_HPP
// Included for access to SIM1::TopologyState and SIM1::ConfigObjects::pingEntries. These definitions are required by the
// autocoder, but are also used in this hand-coded topology.
#include <SIM1/Top/SIM1TopologyDefs.hpp>

// Remove unnecessary SIM1:: qualifications
 ...
 * SIM1::TopologyState see: SIM1TopologyDefs.hpp.
 *
 ...
 *
 * For an explanation of the required type SIM1::TopologyState see: SIM1TopologyDefs.hpp.
 *
