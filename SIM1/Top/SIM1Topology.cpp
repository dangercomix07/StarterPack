// ======================================================================
// \title  SIM1Topology.cpp
// \brief cpp file containing the topology instantiation code
//
// ======================================================================
// Provides access to autocoded functions
#include <SIM1/Top/SIM1TopologyAc.hpp>
// Note: Uncomment when using Svc:TlmPacketizer
//#include <SIM1/Top/SIM1PacketsAc.hpp>
...
Svc::Health::PingEntry pingEntries[] = {
    {PingEntries::SIM1_blockDrv::WARN, PingEntries::SIM1_blockDrv::FATAL, "blockDrv"},
    {PingEntries::SIM1_tlmSend::WARN, PingEntries::SIM1_tlmSend::FATAL, "chanTlm"},
    {PingEntries::SIM1_cmdDisp::WARN, PingEntries::SIM1_cmdDisp::FATAL, "cmdDisp"},
    {PingEntries::SIM1_cmdSeq::WARN, PingEntries::SIM1_cmdSeq::FATAL, "cmdSeq"},
    {PingEntries::SIM1_eventLogger::WARN, PingEntries::SIM1_eventLogger::FATAL, "eventLogger"},
    {PingEntries::SIM1_fileDownlink::WARN, PingEntries::SIM1_fileDownlink::FATAL, "fileDownlink"},
    {PingEntries::SIM1_fileManager::WARN, PingEntries::SIM1_fileManager::FATAL, "fileManager"},
    {PingEntries::SIM1_fileUplink::WARN, PingEntries::SIM1_fileUplink::FATAL, "fileUplink"},
    {PingEntries::SIM1_prmDb::WARN, PingEntries::SIM1_prmDb::FATAL, "prmDb"},
    {PingEntries::SIM1_rateGroup1::WARN, PingEntries::SIM1_rateGroup1::FATAL, "rateGroup1"},
    {PingEntries::SIM1_rateGroup2::WARN, PingEntries::SIM1_rateGroup2::FATAL, "rateGroup2"},
    {PingEntries::SIM1_rateGroup3::WARN, PingEntries::SIM1_rateGroup3::FATAL, "rateGroup3"},
};
...
void configureTopology(const TopologyState& state) {
    ...
    // Note: Uncomment when using Svc:TlmPacketizer
    // tlmSend.setPacketList(SIM1PacketsPkts, SIM1PacketsIgnore, 1);
...
// Public functions for use in main program are namespaced with deployment name SIM1
namespace SIM1 {
