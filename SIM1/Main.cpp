...
#include <SIM1/Top/SIM1Topology.hpp>
// OSAL initialization
#include <Os/Os.hpp>
...
int main(int argc, char* argv[]) {
    ...
    SIM1::setupTopology(inputs);
    SIM1::startSimulatedCycle(Fw::TimeInterval(1,0));  // Program loop cycling rate groups at 1Hz
    SIM1::teardownTopology(inputs);
    (void)printf("Exiting...\n");
    return 0;
}
